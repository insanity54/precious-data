...
class Ripper {
  ...
  async buildSetAbbrIndex() {
    ...
    // cache the setAbbrIndex as a Ripper class property
    this.setAbbrIndex = setAbbrIndex;
    return this.setAbbrIndex;
